/* eslint camelcase: 0 */
/* eslint max-len: 0 */
import { Telegram as T } from './WebAppEvents';

export namespace Telegram.Unsafe {
    export type WebApp = {
         ...
         */
        onEvent(event: 'themeChanged', eventHandler: T.Unsafe.Events.EventHandler<'themeChanged'>): void;
         ...
         */
        onEvent(event: 'viewportChanged', eventHandler: T.Unsafe.Events.EventHandler<'viewportChanged'>): void;
         ...
         */
        onEvent(event: 'mainButtonClicked', eventHandler: T.Unsafe.Events.EventHandler<'mainButtonClicked'>): void;

        /** A method that deletes a previously set event handler. */
        offEvent(
            event: 'themeChanged' | 'viewportChanged' | 'mainButtonClicked',
            eventHandler: T.Unsafe.Events.EventHandler<'themeChanged' | 'viewportChanged' | 'mainButtonClicked'>
        ): void;
    ...
    export type MainButton = {
         ...
         */
        onClick(this: MainButton, handler: T.Unsafe.Events.EventHandler<'mainButtonClicked'>): void;
